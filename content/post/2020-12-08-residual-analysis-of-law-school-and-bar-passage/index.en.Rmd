...
```{r looCompare2}
mod_list2 <- list(school_mod_pca_spline, school_mod_pca_spline_att, school_mod_pca_spline2_att)

mod_loo_list2 <- map(mod_list2, waic)

mod_loo_list2 <- list(`PCA w/o attrition` = mod_loo_list2[[1]],
                      `PCA with attrition` = mod_loo_list2[[2]],
                      `PCA with spline attrition` = mod_loo_list2[[3]])
